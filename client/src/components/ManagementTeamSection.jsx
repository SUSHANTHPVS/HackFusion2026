  ...
  return (
    <section className="glass-card rounded-3xl p-6 shadow-lg md:p-8">
      <div className="mb-6">
        ...
        <h2 className="mt-2 text-3xl font-extrabold text-slate-900">Organizing Team</h2>
        <p className="mt-2 text-slate-600">Core volunteers managing registrations, operations, and hackathon execution.</p>
      </div>
