              ...
              <tbody className="divide-y divide-slate-100 bg-white">
                {logs.map((item) => (
                  <tr key={item._id}>
                    ...
                    <td className="max-w-[220px] truncate px-3 py-2 text-slate-700" title={item.orderId}>{item.orderId}</td>
                    <td className="max-w-[220px] truncate px-3 py-2 text-slate-700" title={item.payload?.paymentId || ""}>
