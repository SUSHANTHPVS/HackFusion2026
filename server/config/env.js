...
const schema = z.object({
  ...
  PAYMENT_METHOD: z.enum(["razorpay", "manual"]).default("razorpay"),
  COLLEGE_ACCOUNT_HOLDER: z.string().min(1).optional(),
  COLLEGE_ACCOUNT_NUMBER: z.string().min(1).optional(),
  COLLEGE_IFSC_CODE: z.string().min(1).optional(),
  COLLEGE_BANK_NAME: z.string().min(1).optional(),
